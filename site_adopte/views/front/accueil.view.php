<?php 
ob_start(); 
echo styleTitreNiveau1("Ils ont trouvés une famille d'accueille !",COLOR_ASSO);
?>
...
<div class="main">
 ...
 <div class="section">
    <img src ='<?= URL ?>public/sources/images/Animaux/chat/bougui/bougui.jpg' />
  ...
  <div class="section">
      ...
      <img src ='<?= URL ?>public/sources/images/Animaux/chien/samdie/samdie.jpg' />
      <div class="descriptions">
          <h1>Samdie</h1>
          <p>
  ...
  <div class="section">
      <img src ='<?= URL ?>public/sources/images/Animaux/chat/aidie/aidie.jpg' /> 
         <div class="descriptions">
...
<div class='row'>
    ...
    <div class='col-6'>
        <div class='row no-gutters border rounded mb-4'>
            <div class='col-auto d-none d-lg-block'>
            <img src ='public/sources/images/Animaux<?= $action['url_image'] ?>' style='height:150px;' alt='<?= $action['libelle_image'] ?>' />
            </div>
