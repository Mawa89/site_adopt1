<?php ob_start();?>
<?= styleTitreNiveau1("Association ADOPT <br/> LAVALLOIS PERRET (92300)", COLOR_ASSO);?>


<div class='row align-items-center mt-5'>
    <div class='col-12 col-lg-3 text-center '>
        <img class='img-fluid' src='<?= URL ?>public/sources/images/Autres/monlogo.png' alt='image logo adopt' />
    </div>
